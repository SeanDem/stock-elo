...
<select
	...
	class="absolute top-5 right-5 p-2 rounded-md bg-primary text-primary-content border-2 accent"
>
	{#each themes as theme}
		<option value={theme}>{theme[0].toUpperCase() + theme.slice(1)} Theme</option>
	{/each}
</select>
